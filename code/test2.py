...
class PatrolNav():
    def __init__(self):
        ...
        self.locations['three'] = Pose(Point(1.2,  2.5802, 0.000), Quaternion(0.000, 0.000, -0.05, 0.98))# check
        ...
        self.locations['three2'] = Pose(Point(2.1629,  2.5802, 0.000), Quaternion(0.000, 0.000, -0.05, 0.98))# check
        self.locations['four2']  = Pose(Point(0.3174, -1.44786, 0.000), Quaternion(0.000, 0.000, 0.9999, 0.00001))# check
        self.locations['five2']  = Pose(Point(0.29322, -0.58135, 0.000), Quaternion(0.000, 0.000, 0.016, 0.99974))# check
        self.locations['three3'] = Pose(Point(2.1629,  2.5802, 0.000), Quaternion(0.000, 0.000, -0.05, 0.98))# check
        self.locations['four3']  = Pose(Point(0.3174, -1.44786, 0.000), Quaternion(0.000, 0.000, 0.9999, 0.00001))# check
        self.locations['five3']  = Pose(Point(0.29322, -0.58135, 0.000), Quaternion(0.000, 0.000, 0.016, 0.99974))# check
        ...
        # sequeue = ['six','five']
        sequeue = ['one', 'two', 'three', 'four', 'five','three2', 'four2', 'five2','three3', 'four3', 'five3']
        # sequeue = ['four', 'five', 'six']
